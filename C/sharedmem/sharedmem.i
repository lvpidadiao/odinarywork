...
# 55 "/usr/include/x86_64-linux-gnu/sys/stat.h" 3 4
typedef __ino_t ino_t;
# 68 "/usr/include/x86_64-linux-gnu/sys/stat.h" 3 4
...
int main()
{
    ...
    char * shared_memory = ((void *)0);
    struct shmid_ds shmbuffer;
    int segment_size;
    const int shared_segment_size = 0x6400;

    segment_id = shmget(100861, getpagesize(), 01000 | 02000 | 0400 | 0200);

    shared_memory = (char *)shmat(segment_id, 0, 0);
    printf("shared memory attached at address %p, the id is %d\n", shared_memory, segment_id);
    shmctl(segment_id, 2, &shmbuffer);
